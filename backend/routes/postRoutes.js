...
import { getAllPosts, getSinglePost, getTopPosts, postCreate, postDelete, postToggleDislike, postToggleLike, postUpdate } from '../controllers/post/PostController.js';
...
router.get('/api/top-posts/', verifyToken, getTopPosts);
